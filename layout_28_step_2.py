"""
Layout 28 Step 2 - AI Image Descriptions
=========================================
Generates visual descriptions for the 1 or 2 active images.
The punchline text element needs no AI generation.
"""
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_28_step_1_tmp.json"
    ...
    if not images:
        out_path = Path("assets/tmp") / f"{scene_id}_layout_28_step_2_tmp.json"
