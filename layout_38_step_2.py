"""
Layout 38 Step 2 - AI Descriptions for img_left and img_right
==============================================================
text_bottom_center needs no AI generation.
Only img_left (P2) and img_right (P3) require AI image descriptions.
"""
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_38_step_1_tmp.json"
    ...
    if not images:
        out_path = Path("assets/tmp") / f"{scene_id}_layout_38_step_2_tmp.json"
