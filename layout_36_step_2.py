"""
Layout 36 Step 2 - AI Descriptions for img_left and img_center
===============================================================
host_explaining.png and arrow.png are static local assets -- no AI needed.
Text element needs no AI generation.
Only img_left (P2) and img_center (P4) require AI image descriptions.
"""
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_36_step_1_tmp.json"
    ...
    candidates = [
        ...
        {"img_id": "img_center", "phrase": step1.get("img_center_phrase", "")},
    ]
    images = [c for c in candidates if c["phrase"]]

    if not images:
        out_path = Path("assets/tmp") / f"{scene_id}_layout_36_step_2_tmp.json"
