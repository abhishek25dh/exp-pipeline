"""
Layout 32 Step 2 - AI Descriptions for Both Images
====================================================
Both images are AI-generated — no static assets in this layout.
"""
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_32_step_1_tmp.json"
    ...
    for img in images:
        ...
        enriched.append({**img, "img_description": img_desc,
