"""
Layout 4 Step 1 — Deterministic Tokenization + Anchor Candidates
=================================================================
Layout 4: Host character + center text anchor + scattered images.
...
def build_candidates(tokens):
    """Build anchor candidates. Sentence-ending spans preferred (Rule 6)."""
    n = len(tokens)
    seen = set()
    cands = []
    for s in range(n):
...
def main():
    ...
    out_path = out_dir / f"{scene_id}_layout_4_step_1_tmp.json"
