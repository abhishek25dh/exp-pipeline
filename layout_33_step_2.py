"""
Layout 33 Step 2 - AI Descriptions for img_left and img_right
==============================================================
Heading text and arrow need no AI generation.
"""
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_33_step_1_tmp.json"
    ...
    if not images:
        out_path = Path("assets/tmp") / f"{scene_id}_layout_33_step_2_tmp.json"
