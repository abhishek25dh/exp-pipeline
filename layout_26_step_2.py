"""
Layout 26 Step 2 - AI Image Descriptions
=========================================
Generates visual descriptions for all active images (below text + right grid).
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_26_step_1_tmp.json"
    ...
    if not images:
        out_path = Path("assets/tmp") / f"{scene_id}_layout_26_step_2_tmp.json"
