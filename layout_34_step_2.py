"""
Layout 34 Step 2 - AI Descriptions for img_left, img_right, img_bottom
=======================================================================
Text elements (text_1, text_2) need no AI generation.
Up to 3 images receive visual descriptions.
"""
...
def main():
    ...
    step1_path = Path("assets/tmp") / f"{scene_id}_layout_34_step_1_tmp.json"
    ...
    candidates = [
        ...
        {"img_id": "img_bottom", "phrase": step1.get("img_bottom_phrase", "")},
    ]
    images = [c for c in candidates if c["phrase"]]

    if not images:
        out_path = Path("assets/tmp") / f"{scene_id}_layout_34_step_2_tmp.json"
